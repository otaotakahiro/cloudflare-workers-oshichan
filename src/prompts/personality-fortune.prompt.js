...
{
  "personalityFortune": {
    "publicPersona": "推しの表の顔（ファンの前で見せる姿、メディアでの印象、よく使う言葉など）について、ファンが共感し憧れを抱くようなストーリーテリングで、**150字以内で記述してください**。",
    "privatePersona": "推しの裏の顔（プライベートで見せそうな一面、仲間や親しい人だけに見せるかもしれない素の性格、本音、クセなど）について、ファンが親近感を覚えるように魅力的に、**150字以内で記述してください**。",
    "mentalAspects": {
       "description": "メンタルの全体的な傾向、強さや繊細さなどについて、ファンが寄り添い方を考えられるようなヒントを交えて、**100字以内で記述してください**。",
       "strengthValue": "メンタルの強さを0から100の数値で示してください。数値が高いほど強いことを意味します。"
    },
    "socialStance": {
       "description": "人付き合いの基本的なスタンスや特徴（例：誰とでも打ち解ける、慎重に距離を測る、グループでの役割など）を、SNSやメディアでの振る舞いと関連付けられるような面白い視点で、**150字以内で記述してください**。"
    },
    "importantThingsInLifeTop3": [
      { "rank": 1, "title": "人生で最も大切にしていることのキーワードや短いフレーズ（例：仲間との絆）。HTMLのID: important-thing-1 に対応します。**20字以内で記述してください**"},
      { "rank": 2, "title": "人生で2番目に大切にしていることのキーワードや短いフレーズ。HTMLのID: important-thing-2 に対応します。**20字以内で記述してください**"},
      { "rank": 3, "title": "人生で3番目に大切にしていることのキーワードや短いフレーズ。HTMLのID: important-thing-3 に対応します。**20字以内で記述してください**"}
    ],
    "currentFortune": {
